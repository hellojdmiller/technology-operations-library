...
const catalog = { version: 1, reviewed_on: '2026-09-19', repository: 'https://github.com/hellojdmiller/technology-operations-library', visibility: 'Private development collection', entries };
...
</style></head><body><main><header><div class="eyebrow">JD Miller · Private resource workshop</div><h1>Technology<br>Operations Library.</h1><p>Operating guidance, AI research, workflows, baseline reviews, portable skills, documentation, training, and guided implementation samples. Start with the job you need to do.</p><p><a href="https://github.com/hellojdmiller/technology-operations-library">Open the private repository</a> · Links require GitHub access.</p></header>
