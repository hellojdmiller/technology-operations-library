...
const catalog = { version: 1, reviewed_on: '2026-09-18', repository: 'https://github.com/hellojdmiller/VCPEIT', visibility: 'Private development collection', entries };
