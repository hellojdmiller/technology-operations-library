...
const descriptions = {
  ...
  'labs/n8n-runtime/README.md': 'Reproduce 47 isolated CLI import and execution cases across fifteen workflows using a pinned n8n image. Check fictional outputs, incomplete evidence, zero-item input, technical failure, and cleanup.',
