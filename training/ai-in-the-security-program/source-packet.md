...
1. Each morning, paste the overnight identity-provider alerts and have it summarise them and tell me which ones I can ignore.
...
4. Explain firewall and audit log lines I do not recognise, by pasting the line and asking what it means.
...
## D2: Identity-provider alert to be summarised
...
3.3 Decisions. An assistant may summarise, draft, explain, and propose. The decision to grant or change access, to close an alert or incident, or to notify anyone is made and recorded by a named person.
