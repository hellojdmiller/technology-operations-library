...
| [Technology landscape](landscape/README.md) | A vendor knowledge graph, generated Obsidian vault, and two years of market signals | Layers, categories, vendors, and typed relations across identity, devices, collaboration, security, network, infrastructure, data and AI, business systems, developer tools, and personal technology, sourced from Wikidata, vendor documentation, and the CNCF and LF AI landscapes; quarterly capital, star, download, survey, and Hacker News signals per category from SEC Form D, GH Archive, package registries, and the Stack Overflow survey |
...
node landscape/lib/build-signals.mjs --check
```
